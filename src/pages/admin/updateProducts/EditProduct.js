...
const EditProduct = () => {
  ...
  useEffect(() => {
    fetch(`https://btpv.onrender.com/v1/product/${path}`)
      .then((res) => res.json())
    ...
    <div className="form-add-product">
      ...
      <div className="row">
        <div className="col-6">
          ...
          <div className="mb-3">
            <span>Tất cả kích thước Sản Phẩm</span>
            <div className="row">
